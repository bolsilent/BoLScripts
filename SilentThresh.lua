...
Config = scriptConfig("Silent Thresh","thresh")
...
Config.Flay:addParam("antiLeona", "Anti Leona", SCRIPT_PARAM_ONOFF, true)
...
player = GetMyHero()
PrintChat(" >> Silent Thresh V1.9 Loaded... -> Fix Chat Spam on Q timer ")
PrintChat(" >> )
...
function castQ(target)
	...
	if ValidTarget(target) then
            ...
            if HitChance >= 2 or 4 or 5 and GetDistance(CastPosition) < 1050 then
